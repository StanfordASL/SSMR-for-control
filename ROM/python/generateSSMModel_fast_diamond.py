...
def generate_ssmr_model(data_dir, save_model_to_data_dir=False):
    ...
    Data['oData'] = utils.import_pos_data(decay_data_dir, 
                                          ...
                                          output_node='all', 
                                          file_type='mat', 
                                          subsample=10, return_velocity=True)
    ...
    if SETTINGS['use_ssmlearn'] == "matlab":
        ...
        ssm = utils.start_matlab_ssmlearn("/home/jalora/SSMR-for-control")
    ...
    if PLOTS:
        ...
        # Debug: Print out linear part of reduced dynamics
        # print(IMInfo['parametrization']['H'])
